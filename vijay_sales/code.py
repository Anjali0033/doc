...
for i in range(12,500,12):
	...
	for link in soup.find_all("ul","Xbxslider Xinner-slider padding-top15"):
		a = link.find("a").get("href")
		# print(a)
		# crawl_details(a)

df = pd.DataFrame(all_items)
df.to_excel("vijay_sales_data_{}.xlsx".format(str_time),index=False)